...
MARKET_RULES = {
    ...
    '交通・物流': [
        '運送','輸送','配送','物流','車両','自動車','バス','鉄道','航空','船舶','タクシー','運行'
    ],
    '施設管理・清掃': [
    ...
    'エネルギー・環境': [
        '電力','電気需給','ガス','燃料','石油','再生可能エネルギー','環境','脱炭素','省エネ',
        '太陽光','蓄電池','水質','大気'
    ],
    '食品・給食': [
        '給食','食材','食品','弁当','飲料','米穀','野菜','肉類','魚介','食堂'
    ],
    '一般物品・備品': [
        '備品','事務用品','家具','什器','消耗品','用紙','文具','制服','被服','コピー用紙','複合機'
    ],
}
